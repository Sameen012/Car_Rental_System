...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section class="menu-content">
        ...
        <div class="sub-menu">
            ...
            <!-- Add Edit and Delete buttons for employees -->
            <?php if(isset($_SESSION['login_client'])) { ?>
                <a href="updatecar.php?car_id=<?php echo $car_id; ?>" class="btn btn-warning">Edit</a>
                <a href="deletecar.php?car_id=<?php echo $car_id; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this car?');">Delete</a>
            <?php } ?>
        </div> 
        </a>
        <?php 
